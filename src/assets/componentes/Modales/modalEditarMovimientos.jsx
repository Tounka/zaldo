...
/*
 * Sustituye al icono del campo cuando ya hay categoria elegida, para que la
 * imagen se vea sin abrir el desplegable.
 */
            ...
            <CampoWrapper>
              <InputConIcono>
                {values.categoria
                  ? (
                    <MiniaturaCategoria
                      $imagen={obtenerImagenCategoriaCompra(values.categoria)}
                      aria-hidden="true"
                    />
                  )
                  : <FaTags />}
